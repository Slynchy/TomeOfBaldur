...
import { Container, DisplayObject, IDestroyOptions, Renderer } from "pixi.js";
...
export class GameObject extends Container {
    ...
    public setIsActive(_val: boolean, _recursive?: boolean): boolean {
        return this.isActive(_val, _recursive);
    }
